...
const AIResume = () => {
  ...
  const handleAnalyze = () => {
    if (!file) return showToast("Please upload a resume file first.", "error");
    setAnalyzing(true);
    showToast("Processing resume with AI... Please wait.", "info");
    ...
    setTimeout(() => {
      ...
      setAnalysis({
        ...
        role: user?.role || "Digital Professional",
        score: 91,
        strengths: [
      ...
      >
        {isLoading ? (
          <div className="text-center py-5">
            <div className="skeleton skeleton-pulse mx-auto mb-4" style={{ width: "250px", height: "40px" }}></div>
            <div className="skeleton skeleton-pulse mx-auto mb-5" style={{ width: "80%", height: "20px" }}></div>
            <div className="skeleton skeleton-pulse mx-auto mb-4" style={{ width: "100%", height: "200px" }}></div>
            <div className="row g-4 mt-3">
              {[1, 2, 3, 4].map(i => (
                <div className="col-3" key={i}>
                  <div className="skeleton skeleton-pulse mx-auto mb-2" style={{ width: "24px", height: "24px", borderRadius: "50%" }}></div>
                  <div className="skeleton skeleton-pulse mx-auto" style={{ width: "60px", height: "10px" }}></div>
                </div>
              ))}
            </div>
          </div>
